  ...
  return (
    <main className="policyPage">
      ...
      <div className="policyGrid">
        ...
        <section><h2>Content-owner alerts</h2><p>When another account shares your public post or picture through CONNECTA, you are alerted and the share keeps attribution to the original source. Exact-file copies are detected deterministically. Cropped, resized or recompressed images can also trigger a high-confidence perceptual-match alert and review hold. A similarity alert is not by itself a legal ownership finding.</p></section>
        <section><h2>Verified businesses</h2><p>A CONNECTA verified-business badge is evidence-backed. Businesses submit legal/trading details and verification evidence for review. The badge cannot be purchased and is not shown until the evidence gate passes. Verification confirms the reviewed business identity; it is not a guarantee of future conduct or product quality.</p></section>
