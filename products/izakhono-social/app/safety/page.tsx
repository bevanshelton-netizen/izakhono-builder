  ...
  return (
    <main className="policyPage">
      ...
      <div className="policyGrid">
        ...
        <section><h2>Content-owner alerts</h2><p>When another account shares your public post or picture through CONNECTA, you are alerted and the share keeps attribution to the original source. Exact-file re-uploads of media already owned by another CONNECTA account are held for review and the earlier uploader is alerted.</p></section>
