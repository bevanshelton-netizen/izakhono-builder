...
curl -fsS --proto '=https' --tlsv1.2 --max-time 20 "$BASE/tiles/10/591/589.png" -o /tmp/nav-public-tile.png && test -s /tmp/nav-public-tile.png && pass "public owned tile" || fail "public owned tile"
