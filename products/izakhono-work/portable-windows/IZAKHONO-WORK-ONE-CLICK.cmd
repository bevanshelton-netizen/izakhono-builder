...
echo [2/5] Downloading IZAKHONO WORK v0.2.2 source...
...
"%ROOT%\python.exe" -c "import sys; sys.path.insert(0,r'%ROOT%'); import app,builder_core; assert app.WORK_VERSION=='0.2.2'; print('IZAKHONO_RUNTIME_VERIFY=PASS')"
if errorlevel 1 goto :fail
