...
set "ROOT=%LOCALAPPDATA%\IzakhonoWork\portable-1.0.0"
set "SRC=https://raw.githubusercontent.com/bevanshelton-netizen/izakhono-builder/c3fbd2a703e6ea17cf537b2f25eb98b2f2b84df2/products/izakhono-work"
...
echo [2/5] Downloading IZAKHONO WORK v1.0.0 source...
...
"%ROOT%\python.exe" -c "import sys; sys.path.insert(0,r'%ROOT%'); import app,builder_core; assert app.WORK_VERSION=='1.0.0'; print('IZAKHONO_RUNTIME_VERIFY=PASS')"
if errorlevel 1 goto :fail
